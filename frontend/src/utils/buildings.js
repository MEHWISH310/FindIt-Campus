/**
 * Single source of truth for the two lost & found collection points --
 * mirrors app/models/building.py's Building enum on the backend. Every
 * report/admin ties to one of these two short codes ("PRP"/"SJT"); the
 ...
 * (rather than blanking it) if a value ever shows up that isn't PRP/SJT --
